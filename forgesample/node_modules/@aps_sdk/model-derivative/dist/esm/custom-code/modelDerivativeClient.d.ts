import { ApiResponse, ApsServiceRequestConfig, SdkManager, BaseClient, IAuthenticationProvider } from "@aps_sdk/autodesk-sdkmanager";
...
export declare class ModelDerivativeClient extends BaseClient {
     ...
     * @throws {RequiredError}
    */
    specifyReferences(urn: string, specifyReferencesPayload: SpecifyReferencesPayload, optionalArgs?: {
        region?: Region;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    ...
    /**
       ...
       * @throws {RequiredError}
       */
    startJob(jobPayload: JobPayload, optionalArgs?: {
        region?: Region;
        xAdsForce?: boolean;
   ...
   * @throws {RequiredError}
   */
    getManifest(urn: string, optionalArgs?: {
        region?: Region;
        acceptEncoding?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
     ...
     * @throws {RequiredError}
     */
    deleteManifest(urn: string, optionalArgs?: {
        region?: Region;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
  ...
  * @throws {RequiredError}
  */
    getDerivativeUrl(derivativeUrn: string, urn: string, optionalArgs?: {
        region?: Region;
     ...
     * @throws {RequiredError}
     */
    headCheckDerivative(urn: string, derivativeUrn: string, optionalArgs?: {
        region?: Region;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<ApiResponse>;
 ...
 */
    getThumbnail(urn: string, optionalArgs?: {
        region?: Region;
        width?: Width;
        height?: Height;
        accessToken?: string;
  ...
  * @throws {RequiredError}
  */
    getObjectTree(urn: string, modelGuid: string, optionalArgs?: {
        region?: Region;
        acceptEncoding?: string;
        xAdsForce?: boolean;
        xAdsDerivativeFormat?: XAdsDerivativeFormat;
     ...
     * @throws {RequiredError}
     */
    getModelViews(urn: string, optionalArgs?: {
        region?: Region;
        acceptEncoding?: string;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
     ...
     * @throws {RequiredError}
     */
    getAllProperties(urn: string, modelGuid: string, optionalArgs?: {
        region?: Region;
        acceptEncoding?: string;
        xAdsForce?: boolean;
        xAdsDerivativeFormat?: XAdsDerivativeFormat;
     ...
     * @throws {RequiredError}
     */
    fetchSpecificProperties(urn: string, modelGuid: string, specificPropertiesPayload: SpecificPropertiesPayload, optionalArgs?: {
        region?: Region;
        xAdsDerivativeFormat?: XAdsDerivativeFormat;
        acceptEncoding?: string;
        accessToken?: string;
