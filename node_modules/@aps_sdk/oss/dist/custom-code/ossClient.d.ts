import { SdkManager, ApiResponse, ApsServiceRequestConfig, BaseClient, IAuthenticationProvider } from "@aps_sdk/autodesk-sdkmanager";
...
export declare class OssClient extends BaseClient {
    objectApi: ObjectsApi;
    bucketApi: BucketsApi;
    ...
    */
    downloadObjectAsync(bucketKey: string, objectKey: string, filePath: string, optionalArgs?: {
    ...
    * @deprecated Use the `downloadObject` method instead.
    */
    downloadObjectAsync(bucketKey: string, objectKey: string, optionalArgs?: {
        cancellationToken?: AbortController;
        requestIdPrefix?: string;
        accessToken?: string;
        onProgress?: (percentCompleted: number) => void;
   ...
   * @memberof OSSApiInterface
   */
    downloadObject(bucketKey: string, objectKey: string, filePath: string, optionalArgs?: {
        cancellationToken?: AbortController;
        requestIdPrefix?: string;
        accessToken?: string;
        onProgress?: (percentCompleted: number) => void;
     ...
     *
     */
    downloadObject(bucketKey: string, objectKey: string, optionalArgs?: {
        cancellationToken?: AbortController;
        requestIdPrefix?: string;
        accessToken?: string;
        onProgress?: (percentCompleted: number) => void;
   ...
   */
    uploadObjectAsync(bucketKey: string, objectKey: string, sourceToUpload: Buffer | string, optionalArgs?: {
        cancellationToken?: AbortController;
        requestIdPrefix?: string;
        accessToken?: string;
        onProgress?: (percentCompleted: number) => void;
     ...
     * @memberof OSSApiInterface
     */
    uploadObject(bucketKey: string, objectKey: string, sourceToUpload: Buffer | string, optionalArgs?: {
        cancellationToken?: AbortController;
        requestIdPrefix?: string;
        accessToken?: string;
        onProgress?: (percentCompleted: number) => void;
     ...
     * @memberof OSSApiInterface
     */
    batchCompleteUpload(bucketKey: string, requests: BatchcompleteuploadObject, optionalArgs?: {
        accessToken?: string;
    ...
    /**
         ...
         * @throws {RequiredError}
         */
    batchSignedS3Download(bucketKey: string, requests: Batchsigneds3downloadObject, optionalArgs?: {
     ...
     * @memberof OSSApi
     */
    batchSignedS3Upload(bucketKey: string, requests: Batchsigneds3uploadObject, optionalArgs?: {
        useAcceleration?: boolean;
        minutesExpiration?: number;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Batchsigneds3uploadResponse>;
    /**
         ...
         * @throws {RequiredError}
         */
    completeSignedS3Upload(bucketKey: string, objectKey: string, contentType: string, body: Completes3uploadBody, optionalArgs?: {
    ...
    /**
         ...
         * @throws {RequiredError}
         */
    copyTo(bucketKey: string, objectKey: string, newObjName: string, optionalArgs?: {
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<ObjectDetails>;
    /**
     ...
     * @memberof OSSApiInterface
     */
    createBucket(xAdsRegion: Region, bucketPayload: CreateBucketsPayload, optionalArgs?: {
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Bucket>;
    /**
         ...
         * @throws {RequiredError}
         */
    createSignedResource(bucketKey: string, objectKey: string, optionalArgs?: {
        access?: Access;
        useCdn?: boolean;
        createSignedResource?: CreateSignedResource;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<CreateObjectSigned>;
    /**
   ...
   * @memberof OSSApiInterface
   */
    deleteBucket(bucketKey: string, optionalArgs?: {
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<ApiResponse>;
    /**
  ...
  * @memberof OSSApiInterface
  */
    deleteObject(bucketKey: string, objectKey: string, optionalArgs?: {
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<ApiResponse>;
    /**
     ...
     * @throws {RequiredError}
     */
    deleteSignedResource(hash: string, optionalArgs?: {
        region?: Region;
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<ApiResponse>;
     ...
     * @memberof OSSApiInterface
     */
    getBucketDetails(bucketKey: string, optionalArgs?: {
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Bucket>;
    /**
    ...
    /**
        ...
        * @memberof OSSApiInterface
        */
    getObjectDetails(bucketKey: string, objectKey: string, optionalArgs?: {
     ...
     * @memberof OSSApiInterface
     */
    getObjects(bucketKey: string, optionalArgs?: {
        limit?: number;
        beginsWith?: string;
        startAt?: string;
        accessToken?: string;
    ...
    /**
        ...
        * @throws {RequiredError}
        */
    getSignedResource(hash: string, optionalArgs?: {
        range?: string;
        ifNoneMatch?: string;
        ifModifiedSince?: string;
     ...
     * @throws {RequiredError}
     */
    signedS3Download(bucketKey: string, objectKey: string, optionalArgs?: {
        ifNoneMatch?: string;
        ifModifiedSince?: string;
        responseContentType?: string;
        responseContentDisposition?: string;
        ...
        accessToken?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Signeds3downloadResponse>;
    /**
     ...
     * @throws {RequiredError}
     */
    signedS3Upload(bucketKey: string, objectKey: string, optionalArgs?: {
        parts?: number;
        firstPart?: number;
        uploadKey?: string;
        minutesExpiration?: number;
     ...
     * @throws {RequiredError}
     */
    uploadSignedResource(hash: string, contentLength: number, body: File, optionalArgs?: {
        contentType?: string;
     ...
     * @throws {RequiredError}
     */
    uploadSignedResourcesChunk(hash: string, contentRange: string, sessionId: string, body: File, optionalArgs?: {
        contentType?: string;
        contentDisposition?: string;
        xAdsRegion?: Region;
        accessToken?: string;
