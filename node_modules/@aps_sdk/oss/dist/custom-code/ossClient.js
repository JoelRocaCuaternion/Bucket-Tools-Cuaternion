...
class OssClient extends autodesk_sdkmanager_1.BaseClient {
    constructor(optionalArgs) {
        ...
        this.objectApi = new api_1.ObjectsApi(optionalArgs.sdkManager);
        this.bucketApi = new api_1.BucketsApi(optionalArgs.sdkManager);
        this.ossFileTransfer = new ossFileTransfer_1.OSSFileTransfer(new fileTransferConfigurations_1.FileTransferConfigurations(3), optionalArgs.sdkManager, optionalArgs.authenticationProvider);
    }
    /**
    ...
    uploadObjectAsync(bucketKey, objectKey, sourceToUpload, optionalArgs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof sourceToUpload === 'string') {
                var buffer = yield fs_1.promises.readFile(sourceToUpload);
